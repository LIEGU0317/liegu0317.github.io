...
categories:
  - 好物分享
  - Tools
index_img: 'https://github.com/LIEGU0317/img/raw/master/Blogimg/202202090030095.png'
hide: false
description: 没抢到冰墩墩，那就用Python写一个吧|Crossin的编程教室冰墩墩代码
comment: twikoo
date: 2022-02-09 00:08:02
...
![冰墩墩](https://github.com/LIEGU0317/img/raw/master/Blogimg/202202090030095.png)


# 2. 代码展示
```python
#执行 python3 bingdundun.py 可画出一个冰墩墩哦

import turtle

# 标题
turtle.title("这里冰墩墩，哈哈哈哈哈")
...
# 代码原作者
[**Crossin的编程教室**](https://space.bilibili.com/17095888?spm_id_from=333.788.b_765f7570696e666f.2)
